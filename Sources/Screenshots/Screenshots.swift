...
extension ScreenShot {
    static var screenShots: [ScreenShot] {
        return [ScreenShot(device: .iphone,
                ...
                ScreenShot(device: .iphone,
                           thumbnail: "/images/apps/cloudnews/iphone6_tn.png",
                           image: "/images/apps/cloudnews/iphone6.png",
                ...
                ScreenShot(device: .ipad,
                           ...
                           description: "iPad 4"),
                ScreenShot(device: .ipad,
                           thumbnail: "/images/apps/cloudnews/ipad5_tn.png",
                           image: "/images/apps/cloudnews/ipad5.png",
                           description: "iPad 5"),
